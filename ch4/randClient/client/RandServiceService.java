 ...
 * 
 */
@WebServiceClient(name = "RandServiceService", targetNamespace = "http://rand/", wsdlLocation = "http://localhost:8888/rand?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8888/rand?wsdl");
